...
<body style="background: url(main.jpg);background-size: 100% " >
<h1 class="alert alert-success rounded-0"><?php echo bankname ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>DBIT</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
