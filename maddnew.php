...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <a href="index.php" > <img src="images/logo.png" width="30" height="30" class="d-inline-block align-top" alt="">
   <!--  <i class="d-inline-block  fa fa-building fa-fw"></i> --><?php echo bankname; ?></a>
  </a>
    ...
    <table class="table">
      <tbody>
        <tr>
          <form method="POST">
          <th>Name</th>
          <td><input type="text" name="name" placeholder="" class="form-control input-sm" required></td>
          <th>Adhaar Card Number</th>
          <td>
            <input type="number" name="cnic" class="form-control input-sm" required>
            <!-- <input name="cnic" class="form-control" type="tel" pattern="[0-9]{12}" placeholder="Adhaar Number" onkeypress="return isNumber(event)"> -->
        ...
        <tr>
          ...
          <th>Date of Birth</th>
          <td>
            <input type="date" name="source" class="form-control input-sm" required>
            <!-- <input type="date"name="source"  class="form-control" id="BirthDate" placeholder="Birth Date"> -->
        </td>
        </tr>
        <tr>
